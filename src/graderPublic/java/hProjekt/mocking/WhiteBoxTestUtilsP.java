...
public class WhiteBoxTestUtilsP {
     ...
     */
    public static <T extends CtElement> Stream<T> getCtElements(final List<Class<?>> classesToSearch,
            final Class<T> toSearch,
    ...
    public static <T extends CtElement> Stream<T> getCtElements(final List<Class<?>> classesToSearch,
            final Class<T> toSearch,
            final CtBodyHolder bodyHolder, final List<CtBodyHolder> searched) {
        ...
        return bodyHolder.getElements(new TypeFilter<>(CtElement.class) {
            ...
            public boolean matches(final CtElement element) {
                return (toSearch.isInstance(element) || (element instanceof CtInvocation<?>))
                        && classesToSearch
                                .contains(element.getParent(CtMethod.class).getDeclaringType().getActualClass());
            }
        })
                .stream()
