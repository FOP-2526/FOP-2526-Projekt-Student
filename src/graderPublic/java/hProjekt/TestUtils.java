...
public abstract class TestUtils {
     ...
     */
    public static void generateJsonTestData(final JsonGenerator generator, final int amount, final String fileName)
            throws IOException {
    ...
    /**
     * Applies the given consumer to the body and its descendants of the given
     * method.
     ...
     */
    public static void iterateMethodStatements(Class<?> clazz, String methodName, Class<?>[] paramTypes,
            Consumer<Iterator<CtElement>> consumer) {
    ...
    public static Player newPlayerInstance(final HexGrid hexGrid,
        ...
        try {
            Constructor<PlayerImpl> constructor = PlayerImpl.class.getDeclaredConstructor(HexGrid.class, Color.class,
                    int.class, String.class, Class.class);
